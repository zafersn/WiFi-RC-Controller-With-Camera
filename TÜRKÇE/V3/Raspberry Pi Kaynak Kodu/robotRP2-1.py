...
print 'Client Baglantisi Bekleniyor...'

#----------------------------------------------------------------------------
#GPIO.cleanup()
# GPIO ayarlari ve tanimlamalari
p1Sol=13  #pinleri tanimladik
p1Sag=19
p2Sol=18
p2Sag=12
...
#on teker dondurme servosu icin
...
def readDataWifi():
 a=0
 while True:
#Clienten gelen verileri alip dataya atadik
   try:
...
# eger servo degeri 100 den kucuk ise arac saga doner, 100 den buyuk ise sola doner
	print 'a',a
	print 'b',b
	print 'c',c
	print 'd',d
	if(a>b): # ileri dogru git 
		if(d>c and a==d): # sadece ileri git
			...
			servoUpdate(120)
		elif(d>c and a>d) : #ileri git sola don
			p1SolPWM.ChangeDutyCycle(a) #d=10
                        p1SagPWM.ChangeDutyCycle(b) #c=0
			...
			servoUpdate(150)
		elif(d<c and a==c):# sadece servonun sola donmesi ve ileri-geri hareket olmamasi icin
			p1SolPWM.ChangeDutyCycle(a) #d=10
                        p1SagPWM.ChangeDutyCycle(b) #c=0
		...
		if(d<c and b==c):# sadece geri git
			p1SolPWM.ChangeDutyCycle(a) #d=10
                        p1SagPWM.ChangeDutyCycle(b) #c=0
			...
			servoUpdate(120)
		elif(d<c and  b>c):# geri sola don
			p1SolPWM.ChangeDutyCycle(a) #d=10
                        p1SagPWM.ChangeDutyCycle(b) #c=0

			p2SolPWM.ChangeDutyCycle(c)#a=0
			p2SagPWM.ChangeDutyCycle(d)#b=10
			servoUpdate(150)#servo sola don	
		elif(d>c and b==d):#sadece servonun saga donmesi icin
			p1SolPWM.ChangeDutyCycle(a) #d=10
                        p1SagPWM.ChangeDutyCycle(b) #c=0

			p2SolPWM.ChangeDutyCycle(c)#a=0
                        p2SagPWM.ChangeDutyCycle(d)#a=0
                        servoUpdate(80)#servo saga don
		else:  # geri saga don
			p1SolPWM.ChangeDutyCycle(a) #d=10
                        p1SagPWM.ChangeDutyCycle(b) #c=0
